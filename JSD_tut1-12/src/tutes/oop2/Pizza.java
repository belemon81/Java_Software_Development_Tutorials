...
public abstract class Pizza implements Comparable<Pizza> {
    ...
    protected String getDescription() {
        ...
        return "A " + this.size.toString().toLowerCase() + " pizza with " + cheeses + (cheeses > 1 ? " cheeses" : " cheese") + ", " + pepperonis + (pepperonis > 1 ? " pepperonis" : " pepperoni") + " and " + hams + (hams > 1 ? " hams" : " ham") + " should cost a total of $" + this.calcCost() + ".";
    }
