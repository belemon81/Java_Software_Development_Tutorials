...
public class HappyFaceColorFrame extends JFrame {
    ...
    public static void main(String[] args) {
        HappyFaceColorFrame drawing = new HappyFaceColorFrame();
    ...
    public void paint(Graphics g) {
        ...
        // draw the coordinates of the content pane space
