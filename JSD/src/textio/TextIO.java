...
public class TextIO {
     ...
     * and nio extra spaces.  This method will handle any type of parameter, even one
     ...
     * this will not produce an error; the user will be prompted repeatedly for input until a legal value
     * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
     * <p>Legal inputs for a boolean input are: true, t, yes, y, 1, false, f, nio, n, and 0; letters can be
     ...
     * nio characters before the end-of-line.  When using standard IO, this will not produce an error.
        ...
        while (true) {
            ...
            if (s.equalsIgnoreCase("true") || s.equalsIgnoreCase("t") ||
                ...
                break;
                    ...
                    s.equalsIgnoreCase("nio") || s.equalsIgnoreCase("n") ||
                    s.equals("0")) {
                ans = false;
                break;
            } else
                errorMessage("Illegal boolean input value.",
                        "one of:  true, false, t, f, yes, nio, y, n, 0, or 1");
        }
        inputErrorCount = 0;
        return ans;
    }
